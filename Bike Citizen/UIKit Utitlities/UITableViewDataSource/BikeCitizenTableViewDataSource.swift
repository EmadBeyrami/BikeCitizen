//
//  BikeCitizenTableViewDataSource.swift
//  Bike Citizen
//
...
/*
 ...
 This is BikeCitizenTableViewDataSource responsible for data source of simple tableViews.
 
 You can easily add new datas to array by confirming your tableViewCell to BikeCitizenTableViewCell.

 */

public protocol BikeCitizenTableViewDelegate: class {
...
extension BikeCitizenTableViewDelegate {
    func tableView(cellForRowAt: IndexPath, cell: UITableViewCell) { }
    func tableView(willDisplay cellIndexPath: IndexPath, cell: UITableViewCell) { }
    func tableView(didEndDisplaying cellIndexPath: IndexPath, cell: UITableViewCell) { }
    func tableView(didSelectRowAt index: IndexPath) { }
...
public class BikeCitizenTableViewDataSource<T: BikeCitizenTableViewCell>: NSObject, UITableViewDataSource, UITableViewDelegate {
    ...
    weak var delegate: BikeCitizenTableViewDelegate?
    
    public init(cellHeight: CGFloat?, items: [T.CellViewModel] = [], tableView: UITableView, delegate: BikeCitizenTableViewDelegate, animationType: CellAnimationType = .none) {
    ...
    public func refreshWithNewItems(_ newItems: [T.CellViewModel], animate: Bool = true) {
        if animate {
